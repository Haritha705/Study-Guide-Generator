...
import { QuizTab } from "@/components/study-pack/QuizTab";
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-6 animate-fade-in">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">
            Performance-Tiered Quiz Drill
          </h1>
          <p className="text-xs text-neutral-400">
            {activePack
              ? `Currently testing on: ${activePack.title}`
              : "Select or generate a study pack to begin adaptive drills."}
          </p>
        </div>

        {activePack ? (
          <QuizTab pack={activePack} />
        ) : (
          <div className="p-12 text-center rounded-2xl bg-neutral-900 border border-neutral-800 space-y-4">
            ...
            <p className="text-xs text-neutral-400 max-w-sm mx-auto">
              Please generate or choose a study pack from the sidebar to take quizzes.
            </p>
            <Link
              href="/create"
